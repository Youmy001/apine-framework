...
final class InstallView extends View
{
    ...
    public function content()
    {
        ...
        $this->data = array(
            'apine_application_https'  => Request::isHttps(),
            'apine_application_mode'   => $application->isDebugMode(),
            'apine_application_secure' => Request::isHttps()
        );
        $this->data = array_merge($this->data, $this->params);
        $this->data = array_merge($this->data, array("apine_view_title" => $this->title));
        $content = $this->process($this->view);
        $this->data[] = $content;
        $this->content = $this->process($this->layout);
