...
final class TranslationDirectory
{
    ...
    public function __construct($a_directory = 'resources/languages')
    {
        ...
        if (!isset(self::$languages[$this->directory])) {
            ...
            if (!isset(self::$languages[$this->directory])) {
                self::$languages[$this->directory]['en-US'] = new TranslationLanguage('en-US',
                    Application::getInstance()->frameworkLocation() . '/src/Includes/en-US.json');
            }
        }
    }
     ...
     * @return TranslationLanguage
     */
    public function getLanguage($a_language_code)
    {
     ...
     * @return boolean
     */
    public function isExistLanguage($a_language_code)
    {
     ...
     * @return Translation
     */
    public function getTranslation($a_language_code)
    {
    ...
    public function translate($a_language_code, $a_key, $a_index = null, $a_pattern = null)
    {
        ...
        $translation = $this->getTranslation($a_language_code);
